...
@section('title', 'Member Belum di Approve')
                    ...
                    <div class="btn-dropdown ">
                      <div class="btn-group dropdown actions-dropodown">
                        ...
                        <div class="dropdown-menu">
                          <a class="dropdown-item" href="#" id="btn-approve"><i class="feather icon-user-check"></i> Approve Member</a>
...
@section('page-script')
  {{-- Page js files --}}
  <script src="{{ Helper::asset(mix('js/scripts/admins/member-unapproved.js')).'?v='.date('Ymdhis') }}"></script>
@endsection
