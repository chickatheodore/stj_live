...
return [
    ...
    "Penempatan Member" => "Penempatan Member",
    "Hierarchy" => "Hirarki",
    "Bonus" => "Bonus",
    "Pohon" => "Pohon",
    "Sponsor" => "Sponsor",
    ...
    "Stock PIN" => "Stock PIN",
    "PIN Tersisa" => "PIN Tersisa",
    "Transfer PIN" => "Transfer PIN",
    "Perpanjang Masa Berlaku TUPO" => "Perpanjang Masa Berlaku TUPO",
    "Lain - Lain" => "Lain - Lain",
    "Upgrade Level" => "Upgrade Level",
    "List Member Stockiest" => "List Member Stockiest",
    "Historical Point" => "Historical Point",
    "Member" => "Member",
    "Bonus Belum Dibayar" => "Bonus Belum Dibayar",
    "Laporan" => "Laporan",
