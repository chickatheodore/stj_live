<?php $__env->startSection('title', 'Pohon Member'); ?>
...
<?php $__env->startSection('vendor-style'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset(mix('vendors/css/charts/jquery.orgchart.min.css'))); ?>">
...
<?php $__env->startSection('vendor-script'); ?>
    ...
    <script src="<?php echo e(asset(mix('vendors/js/charts/jquery.orgchart.min.js'))); ?>"></script>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('page-script'); ?>
    <!-- Page js files -->
    <script src="<?php echo e(asset(mix('js/scripts/members/tree.js'))); ?>"></script>
    <script type="text/javascript">let _mId = <?php echo e(auth()->id()); ?>;</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\repos\stj\dummy\resources\views/members/tree.blade.php ENDPATH**/ ?>