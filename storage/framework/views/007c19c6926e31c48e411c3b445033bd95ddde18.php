              ...
              <div class="ag-grid-btns d-flex justify-content-between flex-wrap mb-1">
                ...
                <div class="ag-btns d-flex flex-wrap">
                  <input type="text" class="ag-grid-filter form-control w-50 mr-1 mb-1 mb-sm-0" id="filter-text-box"
                    placeholder="Search...." />
                    <a href="member/create" class="btn btn-primary">New</a>
...
<?php $__env->startSection('page-script'); ?>
  ...
  <script src="<?php echo e(asset(mix('js/scripts/admins/user.js'))); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\repos\stj\dummy\resources\views//admins/user-list.blade.php ENDPATH**/ ?>