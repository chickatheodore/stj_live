<?php $__env->startSection('title', 'Perpanjang TUPO'); ?>
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="form-group">
                                                <div class="text-center">
                                                    <span id="info-pin" style="background-color: #262c49;padding: 8px;">PIN Tersisa : <?php echo e(number_format($member->pin, 0)); ?></span>
                                                    <div>&nbsp;</div>
                                                    <span style="background-color: #262c49;padding: 8px;">Masa Berlaku : <?php echo e(Carbon\Carbon::parse($member->close_point_date)->format('d-M-Y')); ?></span>
                                                </div>
                                                <div>&nbsp;</div>
...
<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\repos\stj\dummy\resources\views//members/extend.blade.php ENDPATH**/ ?>