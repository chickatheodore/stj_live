...
?>
<div
  class="main-menu menu-fixed <?php echo e(($configData['theme'] === 'light') ? "menu-light" : "menu-dark"); ?> menu-accordion menu-shadow"
    ...
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
      ...
      <li class="nav-item <?php echo e((request()->is($menu->url)) ? 'active' : ''); ?> <?php echo e($custom_classes); ?>">
        <a href="<?php echo e($menu->url); ?>">
          ...
          <span class="menu-title" data-i18n="<?php echo e($translation); ?>"><?php echo e(__('locale.'.$menu->name)); ?></span>
          <?php if(isset($menu->badge)): ?>
          <?php $badgeClasses = "badge badge-pill badge-primary float-right" ?>
          <span
            class="<?php echo e(isset($menu->badgeClass) ? $menu->badgeClass.' test' : $badgeClasses.' notTest'); ?> "><?php echo e($menu->badge); ?></span>
          <?php endif; ?>
        </a>
...
<!-- END: Main Menu--><?php /**PATH D:\repos\stj\dummy\resources\views/panels/sidebar.blade.php ENDPATH**/ ?>